...
<form action="<?php echo base_url()?>admin_content/doeditgallery/file_id/{file_id}/id/{id}" method="POST" name="frmFiles">
  <div class="row">
    <!-- left column -->
    <div class="col-md-10">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="pull-right">
            ...
            <button type="button" class="btn btn-success" onClick="document.location.href='<?php echo base_url()?>admin_content/editgallery/file_id/{file_id}'">Kembali</button>
          </div>
        </div><!-- /.box-header -->
