...
<form action="<?php echo base_url()?>admin_content/doeditnews/file_id/{file_id}/id/{id}" method="POST" name="frmFiles">
  <div class="row">
    <!-- left column -->
    <div class="col-md-10">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="pull-right">
            ...
            <button type="button" class="btn btn-success" onClick="document.location.href='<?php echo base_url()?>admin_content/editnews/file_id/{file_id}'">Kembali</button>
          </div>
        </div><!-- /.box-header -->
...
<form enctype="multipart/form-data">
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Chose Thumbnail</h3>
          <div class="pull-right">
        </div>
        <div class="box-body">
          <input id="uploadfile_thumb" name="uploadfile_thumb" type="file" accept="image/*" class="file-loading">
        </div><!-- /.box -->
      </div><!-- /.box -->
    </div><!-- /.box -->
  </div><!-- /.box -->
