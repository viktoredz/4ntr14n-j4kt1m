...
<form action="<?php echo base_url()?>admin_content/doeditdownload/file_id/{file_id}/id/{id}" method="POST" name="frmFiles">
  <div class="row">
    <!-- left column -->
    <div class="col-md-10">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <div class="pull-right">
            ...
            <button type="button" class="btn btn-success" onClick="document.location.href='<?php echo base_url()?>admin_content/editdownload/file_id/{file_id}'">Kembali</button>
          </div>
        </div><!-- /.box-header -->
      	...
      	<div class="box-body">
            ...
            <br>
              ...
              {dtime}
            <br>
              <label for="exampleInputEmail1">Downloaded : </label>
              {hits}
            <br>
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header">
          ...
          <h5>Tipe file : Pdf, Zip, Rar, Doc, Docx, Jpg, Png, Jpeg</h5>
          <h5>URL : <b>{links}</b></h5>
          <div class="pull-right">
      	</div>
        <div class="box-body">
