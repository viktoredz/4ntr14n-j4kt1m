  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box-body">
        ...
        <button class="btn btn-danger" style="float:right;margin-left:2px"><i class="fa fa-thumbs-o-down"></i>&nbsp;<b>{testimoni_down}</b></button>
        <button class="btn btn-warning" style="float:right;margin-right:2px"><i class="fa fa-thumbs-up"></i>&nbsp;<b>{testimoni_up}</b></button>
      </div>
		  <div class="box-body">
		    <div class="div-grid">
		        <div id="jqxgrid"></div>
...
<script type="text/javascript">
    ...
    $("#menu_dashboard").addClass("active");
		$("#menu_testimoni").addClass("active");
   ...
   var source = {
    ...
    { name: 'waktu', type: 'string'},
		...
		url: "<?php echo site_url('testimoni/json_testimoni'); ?>",
		cache: false,
    ...
    $('#btn-add').click(function(e){
      e.preventDefault();
  		...
  		$.get("<?php echo base_url().'testimoni/add_testimoni/'; ?>", function(data) {
      ...
      $(".jqx-window-close-button").css('display','none');
		...
		$("#jqxgrid").jqxGrid(
		{
			...
			columns: [
        { text: 'Testimonial', datafield: 'content', align: 'center', width: '60%', cellsrenderer: function (row) {
        ...
        { text: 'Waktu', filtertype: 'none', datafield: 'waktu', align: 'center', width: '20%', cellsrenderer: function (row) {
            var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', row);
            return "<div style='width:100%;padding-top:20px;text-align:center'>"+dataRecord.waktu+"</div>";
          }
        }
      ]
		});
    ...
    function detail(id){
      ...
      $.get("<?php echo base_url().'testimoni/detail_testimoni/'; ?>" + id , function(data) {
    ...
    function del_senditm(id){
      ...
      $("#popup1").jqxWindow('close');
      $("#popup_add").jqxWindow('close');
  		$.post("<?php echo base_url().'testimoni/delete_testimoni' ?>/" +id,  function(){
